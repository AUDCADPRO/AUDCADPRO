...
const VTRADE_URL   = "https://social.vtacademy.net/portal/registration/subscription/84538/WEB";
const BROKER_URL   = "https://vtm.pro/nq2Aza";
const WHATSAPP_URL = "https://wa.me/34602099692?text=Hola%20quiero%20info%20del%20copy%20AUDCAD%20PRO";
  ...
  Hablar por WhatsApp
      ...
      <section id="how" className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mt-8 flex gap-3">
          <a href={VTRADE_URL} className="rounded-2xl bg-teal-600/80 hover:bg-teal-600 px-5 py-3 text-sm font-medium text-white">
            Conectar ahora (Unirse al Copy)
          </a>
          <a href={BROKER_URL} className="rounded-2xl border border-neutral-700 px-5 py-3 text-sm font-medium hover:bg-neutral-900">
            Crear cuenta en el broker
          </a>
          <a href="#contact" className="rounded-2xl border border-neutral-700 px-5 py-3 text-sm font-medium hover:bg-neutral-900">
            Hablar antes
          </a>
        </div>
