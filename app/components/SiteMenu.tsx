    ...
    <details className="group relative" data-menu>
      ...
      <summary
        className="list-none cursor-pointer select-none inline-flex items-center gap-2
                   ...
                   px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-900
                   outline-none"
      ...
      {/* Panel */}
      <div
        className="absolute right-0 mt-2 w-72 rounded-xl border border-neutral-800
                   bg-neutral-900/95 backdrop-blur p-2 shadow-xl z-[9999] ring-1 ring-neutral-800/60"
      >
        <nav className="grid gap-1 text-sm text-neutral-200">
          ...
          <a href="/guia-vincular-copy" className="block rounded-lg px-3 py-2 hover:bg-neutral-800/70">
            Guía: Vincular Copy
          </a>

          {/* Otros recursos “largos” */}
