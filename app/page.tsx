...
const faqData = [
  {
    q: "¿Qué es AUDCAD PRO?",
    a: "Es una estrategia de copytrading centrada en el par AUDCAD. Ejecuta una lógica algorítmica conservadora con reglas definidas de riesgo y transparencia de resultados a través de Myfxbook."
  },
  {
    q: "¿Dónde se verifican los resultados?",
    a: "Publicamos la cuenta en Myfxbook (plataforma de auditoría de resultados). Desde tu panel puedes ver crecimiento, drawdown y métricas clave."
  },
  {
    q: "¿Necesito abrir cuenta en un broker específico?",
    a: "Usamos VT Markets por estabilidad y costes. Si prefieres otro broker compatible con MT4/MT5 y copy, consúltanos para confirmar requisitos técnicos."
  },
  {
    q: "¿Quién mantiene la custodia de mi dinero?",
    a: "Tú. El capital siempre está en tu cuenta de broker a tu nombre. AUDCAD PRO no custodia fondos ni tiene acceso a retiradas."
  },
  {
    q: "¿Puedo parar el copy cuando quiera?",
    a: "Sí. Puedes pausar o desconectar el copy en cualquier momento desde tu plataforma o pidiéndonos asistencia. También puedes reducir el tamaño de copia."
  },
  {
    q: "¿Cuál es el depósito mínimo recomendado?",
    a: "Recomendamos al menos 500–1.000 € para que la ejecución del copy sea razonable. Con capitales menores la proporcionalidad de lotes puede ser limitada."
  },
  {
    q: "¿Qué riesgos existen?",
    a: "Operar con derivados conlleva alto riesgo. Puede sufrir pérdidas superiores al depósito por apalancamiento. No inviertas dinero que no puedas permitirte perder. Rendimientos pasados no garantizan rendimientos futuros."
  },
  {
    q: "¿Qué drawdown máximo ha tenido la estrategia?",
    a: "Consulta el drawdown histórico en la página de Myfxbook; ahí verás el valor máximo registrado y su evolución."
  },
  {
    q: "¿Hay comisiones o costes adicionales?",
    a: "El broker cobra su spread/commission habitual. La estrategia puede tener una tarifa de performance o suscripción (si aplica). Te informaremos por escrito antes de conectar el copy."
  },
  {
    q: "¿En qué plataforma funciona?",
    a: "Principalmente en MetaTrader (MT4/MT5) a través de sistemas de copia. Te guiaremos en el alta y conexión."
  },
  {
    q: "¿Cómo empiezo?",
    a: "Abre cuenta en el broker con nuestro enlace, verifica tu identidad, deposita, y conecta el copy. En la web verás el botón “Conectar en VT Markets” con las instrucciones."
  },
  {
    q: "¿Ofrecéis asesoramiento financiero?",
    a: "No. Brindamos información general y la ejecución de una estrategia de copy. No es una recomendación personalizada. Si tienes dudas, consulta con un asesor independiente."
  }
];
...
>
  ...
  <div className="md:col-span-1">
    ...
    <input
      id="email"
      name="email"         // Formspree lo usa como Reply-To
      type="email"
      required
      className="rounded-xl bg-neutral-950 border border-neutral-800 px-4 py-3 text-sm w-full"
      placeholder="Email"
  ...
  <div className="md:col-span-3" role="status" aria-live="polite">
    {status === 'ok' && (
      <p className="text-green-400 text-sm mt-2">¡Gracias! Te responderemos en breve.</p>
    )}
    {status === 'error' && (
      <p className="text-red-400 text-sm mt-2">Ups, hubo un problema. Inténtalo de nuevo.</p>
    )}
  </div>
</form>
  ...
  Al enviar aceptas nuestra <a className="underline" href="/privacidad">Política de Privacidad</a>.
      ...
      <footer className="border-t border-neutral-800">
        <div className="mx-auto max-w-7xl px-4 py-10 grid md:grid-cols-4 gap-8 text-sm">
          ...
          {/* Columna Legal con el botón para reabrir preferencias de cookies */}
          <div>
